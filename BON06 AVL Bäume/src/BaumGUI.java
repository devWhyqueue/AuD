...
//		standardBaum(); // Auskommentieren, wenn nicht gewünscht
	...
	{
		einBaum.einfuegen('\u2744');//Flocke
		einBaum.einfuegen('\u265e');//Pferd
		einBaum.einfuegen('\u2602');//Schirm
		einBaum.einfuegen('♛');
		einBaum.einfuegen('☠');
		einBaum.einfuegen('☣');
		einBaum.einfuegen('❤');
		einBaum.einfuegen('☃');
		einBaum.einfuegen('\u2623'); // Sniper-Rifle, siehe Baum-Ansicht !!EIGENTLICH BIOHAZARD!!
		einBaum.einfuegen('\u2622');//radioaktiv
		einBaum.einfuegen('❆');
		einBaum.einfuegen('✞');
		einBaum.einfuegen('☯');
		einBaum.einfuegen('☤');
	...
	{
		g.setFont(new Font("GNU Unifont", 0, 20));
