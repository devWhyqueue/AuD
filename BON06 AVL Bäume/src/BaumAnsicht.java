...
public class BaumAnsicht
{
	...
	public void ausgebenTeilbaum(AVLKnoten teilbaum, int xParent, int yParent, int xLinks, int xRechts, int y,
		Graphics g)
	{
		if (teilbaum != null)
		{
			...
			g.drawString(teilbaum.toString().equals("\u2623") ? "▄︻̷̿┻̿═━一" : teilbaum.toString(),
				teilbaum.toString().equals("\u2623") ? mitte - 52 : mitte - 2, y); //CHANGED FOR FUN
